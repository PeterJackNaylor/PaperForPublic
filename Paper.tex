...
\address{$^{1}$MINES ParisTech, PSL Research University, CBIO - Centre
  de Bioinformatique, 35 rue St Honoré 77300 Fontainebleau, France; 
$\quad ^{2}$Institut Curie, 75248 Paris Cedex, France; 
$\quad ^{3}$INSERM U900, 75248 Paris Cedex, France; 
$\quad ^{4}$Service de Pathologie, Institut Curie, 75248 Paris Cedex,
France;
$\quad ^{5}$Residual Tumor \& Response to Treatment Laboratory,
RT2Lab, Translational Research Department, Institut Curie, 26, rue d’Ulm, Paris, F-75248, France;
$\quad ^{6}$U932, Immunity and Cancer, INSERM, Institut Curie, Paris, F-75248, France;
...
amounts of these complex and large image data in order to draw
biological conclusions from them and to study cellular and tissular
phenotypes at a large scale. One of the bottlenecks for such an
approach is the automatic segmentation of cell nuclei from this type
of image data. Here, we present a fully automated workflow to segment
nuclei from histopathology image data by training a deep neural
network on a set of annotated images and by proposing a postprocessing
step of the posterior probability maps to split jointly segmented
...
In \cite{Drelie08-298}, they have a partially annotated data set of 
histopathology images for nuclei segmentation. 
...
\label{sec:result}
We conducted our experiments on GPUs via the caffe framework, 

...
variability typically encountered in real histopathology data. Moreover, nuclei spot detection in histopathology has been tackled in breast and colon cancer in \cite{xu2016stacked} and \cite{sirinukunwattana2016locality}. Our setup is different in terms of architecture as we use a very deep architecture for segmentation and not image patches for nuclei centroid detection.

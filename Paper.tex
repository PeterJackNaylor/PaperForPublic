...
% Title.
% ------
\title{Deep Neural Network for Nuclei Segmentation in Histopathology images}
%
% Single address.
% ---------------
%%% Not too sure about who to thank, I guess me, you, phil, and ema?
\name{Peter Naylor, Thomas Walter, J.P. Vert and E. Barillot\thanks{Thanks to XYZ agency for funding.}}
\address{Insitute Curie/ Mines paristech Inserm}
%
% For example:
% ------------
%\address{School\\
...
%
\begin{keywords}
Deep Networks, Nuclei Segmentation, Histpathology. Maybe more?
\end{keywords}
%
...
\section{DataSet}
\label{sec:dataset}
Creating of the data set, some features about it. ITK-snap, some statistics about it.
\section{Methodology}
\label{sec:method}
About different architectures described. Validation scheme.
